...
return new class extends Migration {
    ...
    {
        $this->createMigrationTable('academic_subjects');
        $this->createMigrationTable('audit_academic_subjects', true);
    }
    ...
    public function createMigrationTable($schema_name, $is_audit = false)
    {
        if (!Schema::hasTable($schema_name)) {
            Schema::create($schema_name, function (Blueprint $table) use ($is_audit) {
                ...
                $table->string('code');
                $table->string('type')->comment('Identity college, school level section');
                $table->string('status');
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists('audit_academic_subjects');
    }
};
