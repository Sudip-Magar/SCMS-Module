<div
    x-data="{ drawer: @entangle('drawer'), deleteModal: @entangle('deleteModal'), allowedPermissions: @json($allowedPermissions) }">
        ...
        <x-card separator progress-indicator="saveAcademicFaculty">
            <x-form no-separator wire:submit="saveAcademicFaculty"
                ...
                <div class="grid grid-cols-2 gap-4">
                    <x-input label="{{ __('Enter Faculty name') }}:" placeholder="{{ __('Enter Faculty name') }}"
                             wire:model="facultyForm.name"/>
