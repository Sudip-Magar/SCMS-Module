<div
    ...
    <x-card class="text-xs">
        <x-pagination-filter/>
        <x-table class="text-xs whitespace-nowrap" :headers="$headers" :rows="$structure_data_list" :sort-by="$sortBy" with-pagination>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <x-select label="{{ __('Academic Level') }} " :options="$academic_level" option-value="value"
                                  option-label="label"
                                  x-model="$store.academicStructureSetup.structureData.academic_level"/>
