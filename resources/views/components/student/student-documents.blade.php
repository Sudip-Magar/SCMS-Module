            ...
            <template x-for="(document, index) in {{ $alpine_store }}.documentForm" :key="index">
                <tr x-show="document">
                    ...
                    <td class="px-4 py-2 border-2 border-gray-400 w-3/5">
                        <x-select x-model="document.document_type" class="w-full!"
                    ...
                    <td class="px-4 py-2 border-2 border-gray-400 w-1/5">
                        ...
                        <!-- Upload Box -->
                        <div class="relative w-24 h-24 border-2 border-dashed border-gray-300 rounded-md
                flex items-center justify-center cursor-pointer bg-gray-50 hover:bg-gray-100">
                    ...
                    <td class="px-4 py-2 border-2 border-gray-400 w-30">
                        ...
                        <template x-if="index > 0">
                            <x-button icon="o-minus"
                                      @click.prevent="{{ $alpine_store }}.removeDocumentRow(index)"
